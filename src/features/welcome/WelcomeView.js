  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        {loginScreen ? "Login" : "Create Account"}
      </Text>
      <Space.V s={10} />
      ...
      {loginScreen ? (
        <TouchableOpacity onPress={onPressSignIn}>
          <Text style={styles.topChoice}>Log In</Text>
        </TouchableOpacity>
      ) : (
        <TouchableOpacity onPress={onPressSignUp}>
          <Text style={styles.topChoice}>Sign Up</Text>
        </TouchableOpacity>
      )}
      <Space.V s={5} />
      {loginScreen ? (
        <TouchableOpacity onPress={() => setScreen(false)}>
          <Text style={styles.bottomChoice}>Create Account</Text>
        </TouchableOpacity>
      ) : (
        <TouchableOpacity onPress={() => setScreen(true)}>
          <Text style={styles.bottomChoice}>Go back to Login</Text>
        </TouchableOpacity>
      )}
      <Space.V s={100} />
    </View>
